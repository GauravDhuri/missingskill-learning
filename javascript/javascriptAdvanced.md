...
Execution Context is something that is not often included in the basics. But it is one of the most basic and important thing a JS programmer must know about. What makes Execution Context so important is that it helps us understand how JavaScript code runs. Everything in JS happens inside an 'Execution Context'.  
...
## <span class="header2">Techn Debt</span>
